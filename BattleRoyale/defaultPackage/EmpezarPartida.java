...
public class EmpezarPartida {
	...
	private void mostrarReglas() {
	    ...
	    System.out.println("     🛒 TIENDA - Compra pociones de vida, de energia elemental o mejora tu arma");
	    System.out.println("     ⚔️ ENEMIGO - Batalla contra otro jugador o equipo");
	    System.out.println("     ⛺ CAMPEAR - Pasas el turno escondido");
	    System.out.println("   • Todos los eventos tienen una posibilidad de fracasar");
	    Utilidades.sleep(6000);
	    System.out.println("⚡ SISTEMA DE COMBATE:");
	    System.out.println("   • Ataque básico: Depende del arma equipada");
	    System.out.println("   • Habilidades elementales: 3 por clase, consumen energia elemental");
	    ...
	    System.out.println("   • Huir: probabilidad de huir de la batalla, el que huye pierde la batalla\n");
	    Utilidades.sleep(5000);
	    System.out.println("📈 PROGRESIÓN:");
	    System.out.println("   • Victoria en batalla = Oro + Experiencia");
	    System.out.println("   • Subir de nivel mejora daño ataques elementales");
	    ...
	    System.out.println("   • Opción de imprimir el LOG de partida completa en archivo");
	    System.out.println("==============================================");
